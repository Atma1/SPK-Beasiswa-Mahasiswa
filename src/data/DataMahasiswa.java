...
public class DataMahasiswa extends javax.swing.JFrame {
    ...
    public DataMahasiswa() {
        ...
        jTable1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (row != -1) {
                    String idAccount = jTable1.getValueAt(row, 0).toString(); // Mengambil id_account dari kolom 6 (indeks ke-6)
                    openDetailDataMahasiswa(idAccount);
                }
            }
        });
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("* Klik Data pada Tabel untuk Melihat Detail Data");
    ...
    private void openDetailDataMahasiswa(String idAccount) {
        DetailDataMahasiswa detailFrame = new DetailDataMahasiswa(idAccount);
